    ...
    <div className="post">
      <div className="postWrapper">
          ...
          <div className="postTopRight" onClick={() => setShowMenu(!showMenu)}>
            ...
            {showMenu && (
              <div className="postMenu">
                ...
                <span className="postMenuItem" onClick={() => setHidden(true)}>Hide post</span>
                <span className="postMenuItem" onClick={() => { setReported(true); setShowMenu(false); }}>{reported ? '✓ Reported' : 'Report'}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="postStats">
          <span className="postStatItem"><span className="postLikeEmoji">👍</span> {likeCount}</span>
          <span className="postStatItem" onClick={() => setShowComments(!showComments)}>{comments.length} Comments</span>
        ...
        <div className="postActions">
          ...
          <button className="postActionBtn" onClick={() => setShares(shares + 1)}>
